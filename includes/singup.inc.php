...
switch ($judetcnp){
    ...
    break;
    case "41": $judet='Bucuresti Sector 1';
    break;
    case "42": $judet='Bucuresti Sector 2';
    break;
    case "43": $judet='Bucuresti Sector 3';
    break;
    case "44": $judet='Bucuresti Sector 4';
    break;
    case "45": $judet='Bucuresti Sector 5';
    break;
    case "46": $judet='Bucuresti Sector 6';
    break;
    case "47": $judet='Bucuresti';
    break;
    case "48": $judet='Bucuresti';
    break;
    case "49": $judet='Bucuresti';
    break;
    case "50": $judet='Bucuresti';
    break;
