   ...
   <body>
      ...
      <?php if (isset($_GET['eroare']) && $_GET['eroare']==1) { echo '
         ...
         <div class="container">
             ...
             if (isset($_GET['avatar']) && $_GET['avatar']=='negasit') { echo '
         <div class="container">
              <div role="alert" class="alert alert-danger"><span><strong>Eroare! </strong>Nu ai vreo poză de profil setată ca să poată fi ştearsă!</span></div>
         </div>';}
             if (isset($_GET['avatar']) && $_GET['avatar']=='dimensiune') { echo '
         <div class="container">
              <div role="alert" class="alert alert-danger"><span><strong>Eroare! </strong>Fotografia trebuie să îndeplinească simultan condiţiile: Să fie mai mică de 2mb, lăţimea să fie mai mică decât înălţimea, să aibe înălţimea minimă de 250px</span></div>
         </div>';}
             if (isset($_GET['avatar']) && $_GET['avatar']=='extensie') { echo '
         <div class="container">
              <div role="alert" class="alert alert-danger"><span><strong>Eroare! </strong>Fotografia nu are extensia potrivită! (Extensii acceptate:.png, .jpg, .jpeg)</span></div>
         </div>';}
             if (isset($_GET['avatar']) && $_GET['avatar']=='eroare') { echo '
         <div class="container">
              <div role="alert" class="alert alert-danger"><span><strong>Eroare! </strong>S-a produs o eroare în încărcarea fotografiei!</span></div>
         </div>';}
         ?>
      ...
      <div id="modalConsultationView" role="dialog" tabindex="-1" class="modal fade">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer"><button class="btn btn-danger" data-toggle="modal" data-target="#modalConsultationView">Închide</button></div>
               </form>
            </div>
         </div>
      </div>
      <div id="modalTratamentView" role="dialog" tabindex="-1" class="modal fade">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer"><button class="btn btn-danger" data-toggle="modal" data-target="#modalTratamentView">Închide</button></div>
               </form>
            </div>
         </div>
      </div>
                  ...
                  <form action="db_manage/changePass.php" method="POST">
                     <div class="row" style="margin-top:12px;">
                        <div class="col">
                           ...
                           <input name="actualPass" type="password" class="form-control" />
                        </div>
                     </div>
