...
<html>
   ...
   <body>
         ...
         <div class="container containercustom">
            <div class="row">
               <div class="col">
                  ...
                  <button class="btn btn-info" type="button" onclick="location.href = '/panel/profil/eu';">Începe acum!</button>
               </div>
            </div>
         </div>
      </section>
      <nav class="navbar navbar-dark navbar-expand-md bg-info sticky logo">
         <div class="container">
            <a class="navbar-brand" href="https://hospiweb.novacdan.ro/">&nbsp; &nbsp; &nbsp; &nbsp; HospiWeb</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
